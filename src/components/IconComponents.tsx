...
export const SparkleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2.25c.34 0 .68.02 1.01.07C7.16 3.49 4 7.82 4 12.82c0 5.43 3.99 9.94 9.18 10.13-4.22-.5-7.5-3.8-8-7.95C5.45 10.3 8.37 6.66 12.63 6.2c.2-.02.39-.03.57-.03 4.41 0 8 3.59 8 8 0 .43-.04.85-.11 1.26.25-.32.49-.66.7-1.02.32-.55.53-1.18.53-1.85 0-1.66-1.34-3-3-3-.91 0-1.71.41-2.23 1.05A6.01 6.01 0 0012 8.25c-3.31 0-6 2.69-6 6 0 1.01.25 1.97.69 2.81-3.6-1.52-6.19-5.11-6.19-9.31 0-4.75 3.32-8.73 7.78-9.82C8.79 2.33 9.71 2.25 10.5 2.25h1.5z"/>
    </svg>
);
...
export const FlagIcon: React.FC<{ className?: string; priority: Priority }> = ({ className, priority }) => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className={`${className} ${colorClasses[priority]}`} viewBox="0 0 20 20" fill="currentColor">
...
export const ListCheckIcon: React.FC<{ className?: string }> = ({ className }) => (
...
export const PaperclipIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
        <path strokeLinecap="round" strokeLinejoin="round" d="m18.375 12.739-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3.375 3.375 0 1119.5 7.372L8.552 18.32m.009-.01l-.01.01m5.699-9.941-7.81 7.81a1.5 1.5 0 002.122 2.122l7.81-7.81" />
    </svg>
);
...
export const BrainIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 013.388-1.622m0 0a2.25 2.25 0 003.767-1.973 4.5 4.5 0 00-8.4-2.245c0 .399.078.78.22 1.128m0 0c1.243.27 2.288.644 3.388 1.025a2.25 2.25 0 002.122-2.122 4.5 4.5 0 00-8.4-2.245c0 .399.078.78.22 1.128m0 0A15.998 15.998 0 003 16.122m13.07-7.917c.846-.08 1.663-.14 2.457-.184a4.5 4.5 0 004.478-4.478 4.5 4.5 0 00-4.478-4.478c-1.855 0-3.483.95-4.228 2.345M18 9.75a2.25 2.25 0 01-4.5 0a2.25 2.25 0 014.5 0z" />
    </svg>
);

export const SyncIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.18-3.182m0-11.664a8.25 8.25 0 00-11.664 0L2.985 7.982m11.664 0l3.182 3.182" />
    </svg>
);
